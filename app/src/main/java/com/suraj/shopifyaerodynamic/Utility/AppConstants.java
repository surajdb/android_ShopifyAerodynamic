package com.suraj.shopifyaerodynamic.Utility;
...
public class AppConstants {
    ...
    public static final String kNotFound = "No Result Found";


    public static final int kitemId = 0;
    public static final int kProductFullName = 1;
    public static final int kProductPrice = 2;
